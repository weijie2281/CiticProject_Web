<template>
  <div class="table_class">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.menuname" placeholder="菜单名" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
          ...
          .then(response => {
            ...
            for (var i in responseData) {
              tableData.push({
                ...
                path: responseData[i].path,
                name: responseData[i].name,
                nameZh: responseData[i].nameZh,
                iconCls: responseData[i].iconCls,
                component: responseData[i].component,
                parentId: responseData[i].parentId,
              })
              // console.log(responseData[i].roles)
            }
            this.menusdata = tableData
          })
